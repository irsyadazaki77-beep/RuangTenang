    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-6 py-4 sm:py-6 min-w-0 flex flex-col md:flex-row gap-4 lg:gap-6 h-full">
      ...
      {activeTab === 'akun' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-4">
            <h3 className="text-sm font-bold text-primary flex items-center gap-2 border-b border-default pb-2">
              <UserCheck className="w-4.5 h-4.5 text-secondary" />
              Profil Sesi
            </h3>
            
            <div className="space-y-3">
              <div className="p-3 surface-muted border border-slate-150 rounded-lg flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-semibold text-primary truncate">{safeUser.name}</p>
              ...
              <div className="pt-2">
                <button
                  onClick={onOpenAuth}
                  className="w-full py-2.5 surface-card hover:surface-muted active:bg-slate-100 text-secondary border border-default rounded-xl text-sm font-medium transition-colors shadow-sm flex items-center justify-center gap-2"
                >
      ...
      {activeTab === 'ai' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          {/* Header Card */}
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-default pb-3 gap-2">
              <div>
                    ...
                    >
                      <div className="space-y-2">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {isSelected ? (
                            <span className="flex items-center gap-1 text-xs font-semibold text-teal-700 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/60 px-2 py-0.5 rounded-md">
                              <CheckCircle2 className="w-3.5 h-3.5 text-teal-600" /> Dipilih
                            </span>
                          ) : (
                            <span className="text-[10px] text-muted bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded font-medium">
                              {model.tag}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="p-2 surface-muted/80 rounded-lg border border-default text-[11px] text-secondary space-y-1">
                          <div className="flex items-center justify-between text-[10.5px]">
                            <span className="text-muted flex items-center gap-1">
                              <Gauge className="w-3 h-3 text-muted" /> Kecepatan:
                            </span>
                            <span className="font-semibold text-secondary">{model.speed}</span>
                          </div>
                          <div className="flex items-center justify-between text-[10.5px]">
                            <span className="text-muted flex items-center gap-1">
                              <Cpu className="w-3 h-3 text-muted" /> Penalaran:
                            </span>
                            <span className="font-semibold text-secondary">{model.reasoning}</span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-4">
            ...
            <div className="space-y-3">
              <button
                onClick={onOpenLegal}
                className="w-full flex items-center justify-between p-4 rounded-xl border border-default hover:border-default hover:surface-muted transition-all text-left group"
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 surface-muted text-secondary rounded-lg border border-default shrink-0">
                    <ShieldCheck className="w-5 h-5 text-secondary" />
                  </div>
                  <div>
                    <h4 className="text-sm font-semibold text-primary">Lembar Informasi Legal</h4>
                    <p className="text-xs text-muted mt-0.5">Kebijakan AI & persetujuan medis</p>
                  </div>
                </div>
              ...
              {onOpenPrivacyCenter && (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-primary">Pusat Privasi & Hak Data</h4>
              ...
              {/* 3 Pillars Overview in Settings */}
              <div className="pt-3 border-t border-default space-y-2">
                <span className="text-xs font-bold text-secondary uppercase tracking-wide">
                  3 Pilar Arsitektur Keamanan RuangTenang
                </span>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs">
                  <div className="p-3 surface-muted border border-default rounded-xl space-y-1">
                    <span className="font-bold text-amber-700 dark:text-amber-400 block">1. Temporary / Incognito</span>
                    <p className="text-secondary text-[11px] leading-tight">Obrolan efemeral transient di RAM. Tidak disimpan ke database atau cache.</p>
                  </div>
                  <div className="p-3 surface-muted border border-default rounded-xl space-y-1">
                    <span className="font-bold text-teal-700 dark:text-teal-400 block">2. Private Vault</span>
                    <p className="text-secondary text-[11px] leading-tight">PIN 4-6 digit WebCrypto + Server AES-256-GCM. Mengunci jurnal & skrining.</p>
                  </div>
                  <div className="p-3 surface-muted border border-default rounded-xl space-y-1">
                    <span className="font-bold text-blue-700 dark:text-blue-400 block">3. Instant Conceal</span>
                    <p className="text-secondary text-[11px] leading-tight">Penyamaran layar instan via Alt+X, Ctrl+Shift+L, atau Dobel Esc.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {activeTab === 'memory' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="surface-card rounded-xl p-4 sm:p-5">
            <h3 className="text-sm font-bold text-primary flex items-center gap-2 border-b border-default pb-2 mb-4">
              <RotateCcw className="w-4.5 h-4.5 text-secondary" />
              Memory AI
            </h3>
            <p className="text-sm text-secondary">Manajemen memori jangka panjang AI Anda (fitur segera hadir).</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'keamanan' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-default pb-3 gap-3">
              <h3 className="text-sm font-bold text-primary flex items-center gap-2">
              ...
              <div className="flex bg-slate-100 p-1 rounded-lg gap-1 text-xs">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md font-medium transition ${secTab === 'sessions' ? 'surface-card text-primary shadow-sm' : 'text-secondary hover:text-primary'}`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md font-medium transition ${secTab === 'history' ? 'surface-card text-primary shadow-sm' : 'text-secondary hover:text-primary'}`}
                >
                  Riwayat
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md font-medium transition ${secTab === 'password' ? 'surface-card text-primary shadow-sm' : 'text-secondary hover:text-primary'}`}
                >
                  Sandi
                </button>
              </div>
            ...
            {secTab === 'sessions' && (
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <p className="text-xs text-muted">Daftar perangkat yang terhubung ke akun Anda:</p>
                  {sessions.length > 1 && (
                    <button
                      type="button"
                ...
                {loadingSec ? (
                  ...
                  loginHistory.map((h, i) => (
                    <div key={h.id || i} className="p-2.5 border border-slate-150 rounded-lg flex items-center justify-between text-xs">
                      <div>
                        <div className="font-semibold text-primary">{new Date(h.timestamp).toLocaleString('id-ID')}</div>
                        <div className="text-[10px] text-muted">IP: {h.ip}</div>
                      </div>
            ...
            {secTab === 'password' && (
              <form onSubmit={handleChangePassword} className="space-y-3 max-w-md">
                <div>
                  <label className="block text-xs font-semibold text-secondary mb-1">Kata Sandi Saat Ini</label>
                  <input
                    type="password"
                    ...
                    required
                    placeholder="••••••••••"
                    className="w-full px-3 py-1.5 text-xs border border-default rounded-lg focus:outline-none focus:ring-1 focus:ring-slate-800"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-secondary mb-1">Kata Sandi Baru (Minimal 10 Karakter)</label>
                  <input
                    type="password"
                    value={newPassword}
                ...
                <div>
                  <label className="block text-xs font-semibold text-secondary mb-1">Konfirmasi Kata Sandi Baru</label>
                  <input
                    type="password"
      ...
      {activeTab === 'langganan' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-4 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 min-w-0">
              ...
              <div className={`border rounded-xl p-5 flex flex-col space-y-4 transition-all w-full min-w-0 ${
                safeUser.tier === 'Free' 
                  ? 'border-slate-800 surface-muted/60 ring-2 ring-slate-850/5' 
                  : 'border-default hover:border-default surface-card'
              }`}>
                <div className="space-y-3 flex-1 flex flex-col">
                  <div className="flex items-center justify-between">
                    <span className="px-2 py-0.5 bg-slate-100 text-secondary text-[10px] font-bold uppercase tracking-wide rounded border border-default">
                      Standard
                    </span>
                    {safeUser.tier === 'Free' && (
                      <span className="flex items-center gap-1 text-[10px] text-secondary font-bold">
                        <Check className="w-3.5 h-3.5 text-secondary shrink-0" /> Aktif
                      </span>
                    )}
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-primary">Standard Tier</h4>
                    <p className="text-xs text-secondary mt-1 line-clamp-2">Pendamping emosional dasar harian.</p>
                  </div>
                  <div className="pt-2">
                    <span className="text-xl font-bold text-primary">Rp 0</span>
                    <span className="text-xs text-secondary"> / selamanya</span>
                  </div>
                  
                  {/* Features List */}
                  <ul className="text-xs text-secondary space-y-2.5 pt-4 border-t border-default mt-auto">
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-lg text-sm font-semibold transition-all ${
                      safeUser.tier === 'Free'
                        ...
                        : 'surface-card hover:surface-muted text-primary border border-default shadow-sm active:scale-95'
                    }`}
                  >
              ...
              <div className={`border rounded-xl p-5 flex flex-col space-y-4 transition-all relative overflow-hidden w-full min-w-0 ${
                safeUser.tier === 'Pro' 
                  ...
                  : 'border-default hover:border-default surface-card shadow-sm'
              }`}>
                {/* Popular badge */}
                ...
                <div className="space-y-3 flex-1 flex flex-col">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-primary">Pendamping Pro</h4>
                    <p className="text-xs text-secondary mt-1 line-clamp-2">Dukungan kognitif intensif.</p>
                  </div>
                  <div className="pt-2">
                    <span className="text-xl font-bold text-primary">Rp 29.000</span>
              ...
              <div className={`border rounded-xl p-5 flex flex-col space-y-4 transition-all relative overflow-hidden w-full min-w-0 ${
                ...
                <div className="space-y-3 flex-1 flex flex-col">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-primary">Versi Developer</h4>
                    <p className="text-xs text-secondary mt-1 line-clamp-2">Akses khusus penguji system.</p>
                  </div>
                  <div className="pt-2">
                    <span className="text-xl font-bold text-primary">Tanpa Limit</span>
                    <span className="text-xs text-secondary"> / khusus dev</span>
                  </div>
        ...
        <div className="space-y-4 animate-in fade-in duration-200">
          ...
          <div className="p-5 sm:p-6 bg-gradient-to-br from-teal-500/10 via-sky-500/5 to-transparent border border-teal-200/80 dark:border-teal-800/80 rounded-2xl space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="font-mono px-2 py-0.5 text-xs font-bold bg-teal-100 dark:bg-teal-950/80 text-teal-800 dark:text-teal-200 rounded-md border border-teal-200 dark:border-teal-800">
                      {CURRENT_APP_VERSION}
                    </span>
                    <span className="px-2 py-0.5 text-[11px] font-medium bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 rounded-md border border-emerald-200 dark:border-emerald-800">
                      Stabil & Terkini
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs">
              <div className="p-3 surface-card/80 dark:bg-slate-800/80 border border-default/70 dark:border-slate-700 rounded-xl">
                <span className="text-[10px] uppercase font-bold text-muted dark:text-muted block">Siklus Pembaruan</span>
                <span className="font-semibold text-primary dark:text-slate-200 mt-0.5 block">Harian (Continuous Delivery)</span>
              </div>
              <div className="p-3 surface-card/80 dark:bg-slate-800/80 border border-default/70 dark:border-slate-700 rounded-xl">
                <span className="text-[10px] uppercase font-bold text-muted dark:text-muted block">Proteksi Enkripsi</span>
                <span className="font-semibold text-teal-700 dark:text-teal-300 mt-0.5 block">AES-256-GCM + SHA-256</span>
              </div>
              <div className="p-3 surface-card/80 dark:bg-slate-800/80 border border-default/70 dark:border-slate-700 rounded-xl">
                <span className="text-[10px] uppercase font-bold text-muted dark:text-muted block">Status Server</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-bold text-primary dark:text-slate-200 flex items-center gap-2">
            ...
            <div className="space-y-4">
              {APP_CHANGELOG.map((rel) => (
                <div 
                  key={rel.version}
                  className={`p-4 sm:p-5 surface-card dark:bg-slate-900 border rounded-2xl space-y-3.5 shadow-3xs ${
                    rel.isLatest 
                      ? 'border-teal-500/80 dark:border-teal-500/60 ring-2 ring-teal-500/10' 
                      : 'border-default dark:border-slate-800'
                  }`}
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-default dark:border-slate-800 pb-3">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="font-mono font-extrabold text-sm sm:text-base text-primary dark:text-white">
                        {rel.version}
                      </span>
                      {rel.badge && (
                        <span className={`px-2 py-0.5 text-[10px] font-semibold rounded-md border ${
                          rel.isLatest
                            ...
                            : 'bg-slate-100 dark:bg-slate-800 text-secondary dark:text-slate-300 border-default dark:border-slate-700'
                        }`}>
                          {rel.badge}
                        </span>
                      )}
                      <span className="px-2 py-0.5 text-[10px] font-medium bg-stone-100 dark:bg-slate-800 text-secondary dark:text-slate-300 rounded-md">
                        {rel.periodLabel}
                      </span>
                  ...
                  <div>
                    <h5 className="text-sm font-bold text-primary dark:text-slate-200">
                      {rel.title}
                    </h5>
                    <p className="text-xs text-muted dark:text-muted mt-0.5">
                      {rel.tagline}
                  ...
                  <div className="space-y-2 pt-1">
                    {rel.changes.map(ch => {
                      ...
                      return (
                        <div 
                          key={ch.id}
                          className="p-3 bg-stone-50/70 dark:bg-slate-800/50 border border-default/70 dark:border-slate-700/60 rounded-xl space-y-1"
                        >
                          <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <p className="text-xs text-secondary dark:text-slate-300 pl-0.5">
                            {ch.description}
                          </p>
                          {ch.impact && (
      ...
      {activeTab === 'notifikasi' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="surface-card rounded-xl p-4 sm:p-5 space-y-5">
            <div>
              <h3 className="text-sm font-bold text-primary flex items-center gap-2 border-b border-default pb-2">
            ...
            <div className="space-y-4">
              {/* Checkbox 1 */}
              <label className="flex items-start gap-3 p-3.5 hover:surface-muted/55 rounded-xl border border-default transition-colors cursor-pointer">
                <input
                  type="checkbox"
                ...
                />
                <div className="space-y-0.5">
                  <span className="text-xs font-bold text-primary block">Daily Reminders (Pengingat Harian)</span>
                  <span className="text-[11px] text-muted block leading-relaxed">
